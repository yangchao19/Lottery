package com.yang.lottery.application.process.draw.impl;
...
import com.yang.lottery.domain.rule.service.engine.EngineFilter;
    ...
    public DrawProcessResult doDrawProcess(DrawProcessReq req) {
        ...
        future.addCallback(new ListenableFutureCallback<SendResult<String, Object>>() {
            ...
            public void onFailure(Throwable throwable) {
                ...
                //4.1 MQ 消息发送失败，更新数据库表 user_strategy_export.mq_state = 2【等待定时任务扫描补偿MQ消息】
                activityPartake.updateInvoiceMaState(invoiceVO.getuId(),invoiceVO.getOrderId(),Constants.MQState.FAIL.getCode());
            }

            @Override
            public void onSuccess(SendResult<String, Object> stringObjectSendResult) {
                //4.2 MQ 消息发送失败，更新数据库表 user_strategy_export.mq_state = 1
