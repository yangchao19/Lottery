...
public class ActivityTest {
    ...
    private Logger logger = (Logger) LoggerFactory.getLogger(ActivityTest.class);
    ...
    public void test_activityPartake() {
        PartakeReq req = new PartakeReq("Uhdgkw766120d", 100001L);//Ukdli109op89oi  Uhdgkw766120d
    ...
    @Test
    public  void test_userTakeActivityCountDao() {
        PartakeReq req = new PartakeReq("Uhdgkw766120d", 100001L);
        UserTakeActivityCount userTakeActivityCountReq = new UserTakeActivityCount();
        userTakeActivityCountReq.setuId(req.getuId());
        userTakeActivityCountReq.setActivityId(req.getActivityId());
        UserTakeActivityCount userTakeActivityCount = userTakeActivityCountDao.queryUserTakeActivityCount(userTakeActivityCountReq);
        logger.info("leftCount：{}", JSON.toJSONString(userTakeActivityCount.getLeftCount()));
        logger.info("TotalCount：{}", JSON.toJSONString(userTakeActivityCount.getTotalCount()));
    }
}
